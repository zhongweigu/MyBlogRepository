...
1. **多道批处理操作系统，脱机控制方式(把作业成批地交给计算机)**
2. **分时操作系统，交互式控制方式(多终端访问)**
...
![img](OS-Review-概览、处理器管理、进程管理/e4376086-9598-4d61-a5a8-370cc157fe70.png)
...
**进程作为系统资源<u>分配和保护</u>的独立单位，不需要频繁地切换；**

**线程作为系统<u>调度和分派</u>的基本单位，能轻装运行，会被频繁地调度和切换** 
...
阻塞系统调用可使用Jacketing 启动用户调度， 调整活跃态ULT
